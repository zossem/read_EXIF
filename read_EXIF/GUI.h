...
class MyFrame1 : public wxFrame
{
	...
	public:
		...
		MyFrame1( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("lab 08 GFK"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 758,532 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
